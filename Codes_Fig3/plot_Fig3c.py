...
data=np.load('./Input_data/Magnitude_low_medium_high_flag_200_1000.npz')
magnitude_200_1000_T_flag = data['magnitude_200_1000_T_flag']
magnitude_200_1000_S_flag = data['magnitude_200_1000_S_flag']
magnitude_200_1000_DO_flag = data['magnitude_200_1000_DO_flag']
magnitude_overlap_200_1000_T_S_flag = data['magnitude_overlap_200_1000_T_S_flag']
magnitude_overlap_200_1000_T_DO_flag = data['magnitude_overlap_200_1000_T_DO_flag']
magnitude_overlap_200_1000_T_S_DO_flag = data['magnitude_overlap_200_1000_T_S_DO_flag']

data=np.load('./Input_data/Intensity_low_medium_high_flag_200_1000.npz')
intensity_200_1000_T_flag = data['intensity_200_1000_T_flag']
intensity_200_1000_S_flag = data['intensity_200_1000_S_flag']
intensity_200_1000_DO_flag = data['intensity_200_1000_DO_flag']
intensity_overlap_200_1000_T_S_flag = data['intensity_overlap_200_1000_T_S_flag']
intensity_overlap_200_1000_T_DO_flag = data['intensity_overlap_200_1000_T_DO_flag']
intensity_overlap_200_1000_T_S_DO_flag = data['intensity_overlap_200_1000_T_S_DO_flag']

data=np.load('./Input_data/Duration_low_medium_high_flag_200_1000.npz')
duration_200_1000_T_flag = data['duration_200_1000_T_flag']
duration_200_1000_S_flag = data['duration_200_1000_S_flag']
duration_200_1000_DO_flag = data['duration_200_1000_DO_flag']
duration_overlap_200_1000_T_S_flag = data['duration_overlap_200_1000_T_S_flag']
duration_overlap_200_1000_T_DO_flag = data['duration_overlap_200_1000_T_DO_flag']
duration_overlap_200_1000_T_S_DO_flag = data['duration_overlap_200_1000_T_S_DO_flag']
...
for i in range(360):
    for j in range(180):
        if(~np.isnan(magnitude_200_1000_T_flag[i,j])):
            data=np.array([magnitude_200_1000_T_flag[i,j],intensity_200_1000_T_flag[i,j],duration_200_1000_T_flag[i,j]])
        ...
        if(~np.isnan(magnitude_200_1000_S_flag[i,j])):
            data=np.array([magnitude_200_1000_S_flag[i,j],intensity_200_1000_S_flag[i,j],duration_200_1000_S_flag[i,j]])
            if(np.all(np.isnan(data))):
                continue
            if(np.sum(data==3)>=2):
        ...
        if(~np.isnan(magnitude_200_1000_DO_flag[i,j])):
            data=np.array([magnitude_200_1000_DO_flag[i,j],intensity_200_1000_DO_flag[i,j],duration_200_1000_DO_flag[i,j]])
            if(np.all(np.isnan(data))):
                continue
            if(np.sum(data==3)>=2):
        ...
        if(~np.isnan(magnitude_overlap_200_1000_T_S_flag[i,j])):
            data=np.array([magnitude_overlap_200_1000_T_S_flag[i,j],intensity_overlap_200_1000_T_S_flag[i,j],duration_overlap_200_1000_T_S_flag[i,j]])
            if(np.all(np.isnan(data))):
                continue
            if(np.sum(data==3)>=2):
        ...
        if(~np.isnan(magnitude_overlap_200_1000_T_DO_flag[i,j])):
            data=np.array([magnitude_overlap_200_1000_T_DO_flag[i,j],intensity_overlap_200_1000_T_DO_flag[i,j],duration_overlap_200_1000_T_DO_flag[i,j]])
            if(np.all(np.isnan(data))):
                continue
            if(np.sum(data==3)>=2):
        ...
        if(~np.isnan(magnitude_overlap_200_1000_T_S_DO_flag[i,j])):
            data=np.array([magnitude_overlap_200_1000_T_S_DO_flag[i,j],intensity_overlap_200_1000_T_S_DO_flag[i,j],duration_overlap_200_1000_T_S_DO_flag[i,j]])
            if(np.all(np.isnan(data))):
                continue
            if(np.sum(data==3)>=2):
...
plt.title('Fig.3c',fontdict={'weight':'bold','size':25})
fig.tight_layout()

plt.savefig('./Fig3c.pdf', dpi=750, bbox_inches='tight')
plt.show()
